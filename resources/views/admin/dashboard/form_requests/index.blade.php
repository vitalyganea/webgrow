        ...
        <x-slot:content>
            ...
            <div class="overflow-x-auto bg-card rounded shadow border border-border">
                <table class="w-full table-auto">
                    ...
                    @forelse ($formRequests as $request)
                        <tr class="border-t border-border hover:bg-accent/50 transition-colors">
                            ...
                            <td class="px-4 py-2 space-x-2">
                                <button type="button" class="text-primary hover:text-primary/80 hover:underline transition-colors show-btn" data-request-body="{{ $request->requestBody }}" data-request-id="{{ $request->id }}">
                                    Show
                                </button>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-4 py-4 text-center text-muted-foreground">No form requests found.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
