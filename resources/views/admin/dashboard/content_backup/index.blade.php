<x-admin.layouts.auth title="Content Backups">
    ...
    <div class="overflow-x-auto bg-white rounded shadow">
        <table class="w-full table-auto">
            ...
            @forelse ($contentBackups as $contentBackup)
                <tr class="border-t">
                    ...
                    <td class="px-4 py-2 space-x-2">
                        <button type="button" class="text-blue-600 hover:underline restore-btn" data-id="{{ $contentBackup->id }}">
                            Restore
                        </button>
                        <form action="{{ route('admin.delete.content-backup', $contentBackup) }}" method="POST" class="inline delete-form">
                            ...
                            <button type="button" class="text-red-600 hover:underline delete-btn" data-id="{{ $contentBackup->id }}">
                                Delete
                            </button>
                        </form>
                    </td>
            ...
            @empty
                <tr>
                    <td colspan="3" class="px-4 py-4 text-center text-gray-500">No backups found.</td>
                </tr>
            @endforelse
            </tbody>
        </table>
