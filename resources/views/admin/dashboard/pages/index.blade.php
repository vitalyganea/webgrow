        ...
        <x-slot:content>
            ...
            <div class="overflow-x-auto bg-card rounded shadow border border-border">
                <table class="w-full table-auto">
                    ...
                    @forelse ($pages as $page)
                        <tr class="border-t border-border hover:bg-accent/50 transition-colors">
                            ...
                            <td class="px-4 py-2 space-x-2">
                                ...
                                <a href="{{ route('admin.edit.page', ['group_id' => $page->group_id]) }}" class="text-primary hover:text-primary/80 hover:underline transition-colors">Edit</a>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-4 py-4 text-center text-muted-foreground">No pages found.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
